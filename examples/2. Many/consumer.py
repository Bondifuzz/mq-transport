...
class MQAppInitializer:
    ...
    async def _configure_input_channels(self):
        ...
        channel = await self._app.create_consuming_channel(queues.many)
        channel.add_consumer(MC_ManyEven())
        channel.add_consumer(MC_ManyOdd())
